...
- 🤖 **NEW: All-in-One Automation System** (10 modules, complete automation)

---

## 🤖 NEW: All-in-One Automation System (v2.0)

**The ultimate "set it and forget it" solution** - One script that manages **every aspect** of Bitburner!

### What It Does

Run **ONE command** to automate your entire game:

```bash
run utils/auto-manager.js
```

This single script coordinates **10 automation modules**:

1. 💰 **Hacking** - Finds best targets, deploys smart-batcher automatically
2. 🖥️ **Servers** - Buys & upgrades servers with ROI analysis
3. 🌐 **Hacknet** - Manages hacknet farm for passive income
4. 🏛️ **Factions** - Auto-joins factions, farms reputation
5. 🧬 **Augmentations** - Plans optimal aug purchases (tracks price multipliers)
6. 🏢 **Companies** - Applies to jobs, seeks promotions
7. ⚔️ **Bladeburner** - Runs operations, upgrades skills
8. 👥 **Gangs** - Recruits members, manages ascension
9. 🏭 **Corporations** - Tracks divisions, provides recommendations  
10. 🎮 **Go** - Plays Go games in background for rewards

### Key Features

✨ **True Idle Gaming**
- Manages everything while you're AFK
- Makes optimal decisions every 5 minutes
- Gracefully handles locked APIs (auto-enables as you progress)

🎯 **Intelligent Coordination**
- Prioritizes critical actions (high → medium → low)
- Avoids conflicts (won't work for faction & company simultaneously)
- Shows pending actions for awareness

📊 **Unified Dashboard**
- See all module statuses at a glance
- Track income from all sources
- Monitor recent actions across all systems
...
**Step 3**: Go AFK! The system handles:
- Making money (hacking + hacknet)
...
|--------|-------------|----------------|
| Hacking, Servers, Hacknet | None | ✅ From game start |
| Go | Go minigame unlocked | ✅ Early game |
...
1. System detects new faction invitation → Joins faction (high priority)
2. Needs more reputation → Starts faction work (medium priority)
3. Meanwhile: Hacknet profitable → Buys node (low priority)
4. Background: Go game finishes → Starts new game (low priority)
5. All while: Smart-batcher keeps making money!

📖 **Learn More**: See `modules/README.md` for detailed module documentation
...
### Version 2.0.0 (November 14, 2025) ⭐ MAJOR RELEASE
**All-in-One Automation System** 🤖🎮
- **10 integrated modules** managing every aspect of gameplay
- NEW: `utils/auto-manager.js` - Enhanced orchestrator with module coordination
- NEW: `modules/faction-manager.js` - Intelligent faction automation
- NEW: `modules/augmentation-tracker.js` - Optimal aug purchase planning
- NEW: `modules/company-automator.js` - Career management automation
- NEW: `modules/bladeburner-commander.js` - Bladeburner operations
- NEW: `modules/gang-manager.js` - Gang management & ascension
- NEW: `modules/corporation-manager.js` - Corporation tracking
- NEW: `modules/go-commander.js` - Go game automation
- NEW: `go4.js` - Advanced 5-stage Go AI strategy
- **One command** to automate: hacking, servers, hacknet, factions, companies, augs, bladeburner, gangs, corps, and Go!
...
- See [All-in-One System](#🤖-new-all-in-one-automation-system-v20) section above for details
